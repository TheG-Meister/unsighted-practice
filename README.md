...
This setup guide is for v0.3.3.
...
* [Unsighted Practice](https://github.com/TheG-Meister/unsighted-practice/releases/tag/v0.3.3) `unsighted-practice-v0.3.3.zip` - this mod
